...
class Cron(models.Model):
    ...
    def onchange_backup_destination(self):
        ...
        if self.backup_destination == 'dropbox':
            ...
            flow = dropbox.DropboxOAuth2FlowNoRedirect('gdusiuuu3jlqroy', 'es9h8i52qo4lgwi', token_access_type='offline')
    ...
    def constrains_dropbox(self):
        ...
        if self.backup_destination == 'dropbox':
            ...
            self.dropbox_access_token = result.refresh_token
    ...
    def _get_selection_field_value(self, field, key):
        my_model_obj = self
    ...
    def create_backup(self, check=False):
        ...
        if self.backup_destination == 'dropbox':
            ...
            client = dropbox.Dropbox(app_key='gdusiuuu3jlqroy', app_secret='es9h8i52qo4lgwi', oauth2_refresh_token=self.dropbox_access_token)
        ...
        if self.backup_destination == 'google_drive':
            ...
            def _getFolderID(folder_id, parent):
