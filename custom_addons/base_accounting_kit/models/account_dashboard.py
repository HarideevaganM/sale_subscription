...
class DashBoard(models.Model):
    ...
    @api.model
    def _get_income_this_year(self, *post):
    ...
    @api.model
    def _get_income_last_year(self, *post):
    ...
    @api.model
    def _get_income_last_month(self, *post):
    ...
    @api.model
    def _get_income_this_month(self, *post):
    ...
    @api.model
    def _get_overdues_this_month_and_year(self, *post):
    ...
    @api.model
    def _get_top_10_customers_month(self, *post):
        record_invoice = {}
        record_refund = {}
        company_id = self.get_current_company_value()
        states_arg = ""
    ...
    @api.model
    def _get_total_invoice(self, *post):
    ...
    @api.model
    def _get_total_invoice_current_year(self, *post):
    ...
    @api.model
    def _get_total_invoice_current_month(self, *post):
    ...
    @api.model
    def _get_total_invoice_this_month(self, *post):
    ...
    @api.model
    def _get_total_invoice_last_month(self):
    ...
    @api.model
    def _get_total_invoice_last_year(self):
    ...
    @api.model
    def _get_total_invoice_this_year(self):
    ...
    def _get_current_company_value(self):
