...
class SalemanDashboard(http.Controller):
    ...
    def _get_values_salesman(self, salesman_id, start_date, end_date):
    ...
    def _get_template_name(self, line):
        ...
        sub = request.env['sale.order'].search([('analytic_account_id', '=', line.account_analytic_id.id), ('is_subscription', '=', True)])
