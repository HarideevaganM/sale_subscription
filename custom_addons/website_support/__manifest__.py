{
    ...
    "assets": {
            'web.assets_backend': [
                '/website_support/static/src/css/kanban.css',
                '/website_support/static/src/js/website_support_backend.js',
            ],
            'website.assets_editor': [
                '/website_support/static/src/js/website_support_editor.js',

            ],
            'website.assets_frontend': [
                '/website_support/static/src/css/support.css',
            ]
        }
}