...
class SupportTicketController(http.Controller):
    ...
    def support_approve(self, ticket_id, **kwargs):
        ...
        awaiting_approval = request.env.ref('website_support.awaiting_approval')
        ...
        if support_ticket.approval_id.id == awaiting_approval.id:
            ...
            website_ticket_state_approval_accepted = request.env.ref('website_support.website_ticket_state_approval_accepted')
            ...
            approval_accepted = request.env.ref('website_support.approval_accepted')
            ...
            notification_template = request.env.ref('website_support.support_ticket_approval_user')
            # support_ticket_menu = request.env['ir.model.data'].sudo().get_object('website_support', 'website_support_ticket_menu')
            support_ticket_menu = request.env.ref('website_support.website_support_ticket_menu')
            # support_ticket_action = request.env['ir.model.data'].sudo().get_object('website_support', 'website_support_ticket_action')
            support_ticket_action = request.env.ref('website_support.website_support_ticket_action')

            for my_user in support_ticket.category_id.cat_user_ids:
                fields = ['email_from', 'email_to', 'subject', 'body_html']
                values = notification_template.generate_email(support_ticket.id, fields)
    ...
    def support_disapprove(self, ticket_id, **kwargs):
        ...
        if support_ticket.approval_id.id == awaiting_approval.id:
            ...
            website_ticket_state_approval_rejected = request.env.ref('website_support','website_ticket_state_approval_rejected')
            ...
            approval_rejected = request.env.ref('website_support.approval_rejected')
    ...
    def support_account_create_process(self, **kw):
        ...
        if setting_allow_user_signup:
            ...
            support_group = request.env.ref('website_support.support_group')
    ...
    def support_ticket_view_list(self, **kw):
        ...
        no_approval_required = request.env.ref('website_support.no_approval_required')
    ...
    def support_portal_ticket_comment(self, **kw):
        ...
        support_ticket.state_id = request.env.ref('website_support.website_ticket_state_customer_replied')
    ...
    def support_ticket_comment(self, **kw):
        ...
        if ticket.partner_id.id == http.request.env.user.partner_id.id:
            ...
            ticket.state_id = request.env.ref('website_support.website_ticket_state_customer_replied')
    ...
    def support_ticket_close(self, **kw):
        ...
        if ticket.partner_id.id == http.request.env.user.partner_id.id or ticket.partner_id in http.request.env.user.partner_id.stp_ids:
            ...
            customer_closed_state = request.env.ref('website_support.website_ticket_state_customer_closed')
