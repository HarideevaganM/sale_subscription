...
class report_account_followup_report(models.AbstractModel):
    ...
    #@api.multi
    def _get_html(self, options, line_id=None, additional_context=None):
    ...
    def _get_pdf(self, options, minimal_layout=True):
    ...
    def _get_report_value(self, partner, options):
    ...
    def _get_post_message(self, options):
...
class account_report_followup_all(models.AbstractModel):
    ...
    def _get_partners_in_need_of_action(self, options):
