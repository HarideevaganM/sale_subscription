        ...
        if wizard.type_ledger == 'aged':
            ...
            if wizard.summary:
                ...
                def _set_line(line):
                    ...
                    sheet.write(i, 7, line.get('narration', ''))
                    sheet.write(i, 8, line.get('displayed_name', ''))
                    sheet.write(i, 9, line.get('partner_name', ''))
                    sheet.write(i, 10, get_date_format(line.get('date_maturity', '')))
                    ...
                    if line.get('amount_currency', ''):
                        sheet.write(i, 14, _get_data_float(line.get('amount_currency', '')), workbook.add_format({'num_format': line.get('currency')}))
                    sheet.write(i, 15, line.get('matching_number', ''))
