...
class AccountStandardLedger(models.TransientModel):
    ...
    def _sql_unaffected_earnings(self):
        ...
        INSERT INTO account_report_standard_ledger_line
            (report_id, create_uid, create_date, account_id, type, type_view, date, narration, debit, credit, balance, cumul_balance, company_currency_id, reconciled, report_object_id)
        SELECT
            %s AS report_id,
            %s AS create_uid,
            NOW() AS create_date,
    ...
    def _sql_init_balance(self):
        ...
        query = """
        INSERT INTO account_report_standard_ledger_line
            (report_id, create_uid, create_date, account_id, partner_id, group_by_key, type, type_view, date, narration, debit,  credit, balance, cumul_balance, company_currency_id, reconciled, report_object_id)
    ...
    def _sql_lines_compacted(self):
        query = """
        INSERT INTO account_report_standard_ledger_line
            (report_id, create_uid, create_date, account_id, type, type_view, date, narration, debit, credit, balance, cumul_balance, company_currency_id, report_object_id)
