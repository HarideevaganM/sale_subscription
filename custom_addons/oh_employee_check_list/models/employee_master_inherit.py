...
class HrEmployeePublic(models.Model):
    ...
    entry_progress = fields.Float(string='Entry Progress', store=True, related='employee_id.entry_progress')

    exit_progress = fields.Float(string='Exit Progress', store=True, help="Percentage of Exit Checklists's", related='employee_id.exit_progress')

    maximum_rate = fields.Integer(related='employee_id.maximum_rate')
    check_list_enable = fields.Boolean(invisible=True, related='employee_id.check_list_enable')
